...
# Show some OS info
print("Current working directory:", os.getcwd())  # prints the folder where this script is running
print("Python executable:", sys.executable)  # prints the path of the Python interpreter being used

# Generate random numbers
numbers = [random.randint(0, 10) for _ in range(10)]  # list of 10 random integers between 0 and 10
...
ascii_banner = pyfiglet.figlet_format("Python Rocks!")  # generate ASCII art for the text
